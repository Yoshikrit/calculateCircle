...
public class CalculateServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>For the circle with radius = " + request.getParameter("radius") + "</h1>");
            out.println("<h1>Area is " + Double.toString(area) + "</h1>");
            out.println("<h1>Parameter is  " + Double.toString(parameter) + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
